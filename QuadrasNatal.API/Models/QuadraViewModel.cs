...
namespace QuadrasNatal.API.Models
{
    ...
    {
        public QuadraViewModel(int id, string nome, string descricao, string tipoSuperficie, bool cobertura, bool iluminacao, bool disponivel, List<CourtComments> comments)
        {
            Id = id;
            Nome = nome;
            Descricao = descricao;
        ...
        public static QuadraViewModel FromEntity(Court entity) 
